...
const TOKEN_MINT = new PublicKey('6sTBrWuVVielTdbYPK9kAypnwpXJqqrp6yDzTB1PK3Mp7');

export default function Minimal() {
  const { publicKey, connected, disconnect } = useWallet();
  const { setVisible } = useWalletModal();
  const [balance, setBalance] = useState('0');
  const [buttonLabel, setButtonLabel] = useState('Connect');  // Local state to force immediate update
